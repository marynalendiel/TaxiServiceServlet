...
<head>
    ...
    <title><fmt:message key='admin.info'/></title>
</head>
<body>
<div class="header">
...
<div id="demo">
    <h1><fmt:message key='admin.info'/></h1>

    <div class="container">
        <div class="search-box">
            <form action=<%= request.getContextPath() %>/controller method="get">
                <input type="hidden" name="command" value="getOrders"/>
                <input type="text" name="userId" pattern="[0-9]+" class="input-search btn-width" placeholder="<fmt:message key='admin.userid'/>">
        ...
        <div class="search-box">
            <form action=<%= request.getContextPath() %>/controller method="get">
                <input type="hidden" name="command" value="getOrders"/>
                <input class="input-search btn-width" type="date" name="date">
        ...
        <div class="table-responsive-vertical shadow-z-1">
            ...
            <table id="table" class="table table-hover table-mc-light-blue">
                ...
                <tr>
                    ...
                    <th scope="col"><a href="controller?command=getOrders&sort=date" class="more"><fmt:message key='menu.date'/></a></th>
                    <th scope="col"><a href="controller?command=getOrders&sort=price" class="more"><fmt:message key='menu.price'/></a></th>
